...
public class Configuration
{
    ...
    /// and serve it at the path specified in OpenApiSettings.FilePath,
    ...
    public Configuration(string content)
    {
        ...
        try
        {
            ...
            lastProp = "MaxConnections";
            MaxConnections = root.GetProperty("MaxConnections").GetUInt16();
            lastProp = "PublicURL";
            PublicUrl = root.GetProperty("PublicURL").GetString() ?? "";
            lastProp = "StaticFolderPath";
    ...
    /// <param name="ipMode">Sets whether listen only to ipv6 addresses</param>
    /// <param name="requestMaxSize"></param>
    /// <param name="defaultSessionExpirationTime"></param>
    /// <param name="sslConfiguration"></param>
    public Configuration(string address, ushort port, string staticPath, Debugger? debugInfo = null,
        IpMode ipMode = IpMode.Any, int requestMaxSize = KILOBYTE, ulong? defaultSessionExpirationTime = null,
    ...
    public void Get(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Get, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Post(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Post, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Head(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Head, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Put(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Put, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Delete(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Delete, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Patch(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Patch, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Trace(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Trace, func);
    ...
    /// <param name="path">Mapping</param>
    /// <param name="func">Function that will handle the request</param>
    public void Options(string path, Delegate func) => AddExpressMapping(path, HttpMethod.Options, func);
    ...
    /// </summary>
    /// <param name="cookie">The cookie to add or replace</param>
